...
public class Trie {
    ...
    private void wordsOfPrefixRec(TrieNode start, String word, ArrayList<String> list, String prefix){
        ...
        for(int i=0;i<ALPHABET_SIZE;i++){
            if(start.children[i]!=null){
                ...
                word+=character;
                wordsOfPrefixRec(start.children[i],word,list,prefix);
    ...
    private void print(TrieNode start,String word){
        if(start.isTerminal){
